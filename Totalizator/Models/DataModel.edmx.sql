...
-- --------------------------------------------------
-- Date Created: 01/10/2020 13:57:03
-- Generated from EDMX file: C:\Users\german.samolazov\Desktop\totalizator\Totalizator\Models\DataModel.edmx
-- --------------------------------------------------
...
-- Creating foreign key on [TeamdSecondId] in table 'Events'
ALTER TABLE [dbo].[Events]
ADD CONSTRAINT [FK_Events_Teams1]
    FOREIGN KEY ([TeamdSecondId])
    REFERENCES [dbo].[Teams]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
